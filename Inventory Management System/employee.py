...
class employeeClass:
    def __init__(self,root):
        ...
        #---------------title----------------
        title=Label(self.root,text="Employee Details",font=("goudy old style",15),bg="#0f4d7d",fg="white").place(x=40,y=100,width=1200) 
        ...
        lbl_password=Label(self.root,text="password",font=("goudy old style",15),bg="white").place(x=400,y=230) 
        ...
        txt_password=Entry(self.root,textvariable=self.var_pass,font=("goudy old style",15),bg="lightyellow").place(x=500,y=230,width=180)
            ...
            if self.var_emp_id.get()=="":
                ...
                if row!=None:
                    messagebox.showerror("error","this employee id already assigned, try different",parent=self.root)
                     ...
                     con.commit()
                     messagebox.showinfo("Sucess","employee details added sucessfully",parent=self.root)
                     self.show()
            ...
            if self.var_emp_id.get()=="":
                ...
                if row==None:
                    messagebox.showerror("error","invalid employee ID",parent=self.root)
                     ...
                     con.commit()
                     messagebox.showinfo("Sucess","employee details updated sucessfully",parent=self.root)
                     self.show()
        except Exception as ex:
            messagebox.showerror("error",f'error due to: {str(ex)}',parent=self.root)
